...
# File paths
beta_file = f"stored_data/map_beta_{period}.csv"  
swe_file = f"stored_data/swe_{period}.csv"  
output_folder = f"/Users/hakon/SnowAnalysis_HU/Output/ForMaster/"  
output_mean_file = output_folder + f"reliability_vs_gumbel_mean_{period}.pdf"
output_cov_file = output_folder + f"reliability_vs_gumbel_cov_{period}.pdf"
...
# Categorize 'SWE_Gumbel_Mean' into {period} bins: 0-200, 201-700, >700
...
# Apply categorization to create a {period} column
...
for group, color in color_map.items():
    ...
    if not group_df.empty:
        # Linear regression
        slope, intercept = np.polyfit(group_df["SWE_Gumbel_CoV"], group_df["var"], 1)
